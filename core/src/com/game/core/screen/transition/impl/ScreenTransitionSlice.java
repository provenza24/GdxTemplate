package com.game.core.screen.transition.impl;
...
public class ScreenTransitionSlice extends AbstractScreenTransition {
	...
	public void render(SpriteBatch batch, Texture currScreen, Texture nextScreen, float alpha) {
		...
		batch.begin();
		batch.draw(currScreen, 0, 0, 0, 0, w, h, 1, 1, 0, 0, 0, currScreen.getWidth(), currScreen.getHeight(), false,
				true);
		if (easing != null)
